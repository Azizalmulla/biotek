...
const steps: Step[] = [
  {
    ...
    description: "Login as doctor/nurse and select a patient. Role-based access control ensures data privacy.",
    icon: (
  ...
  },
  {
    ...
    description: "Review risk factors, ask AI Research Assistant questions, and get evidence-based treatment protocols.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Generate treatment plans with AI Treatment Optimizer. All actions logged for compliance.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
